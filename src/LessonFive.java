...
public class LessonFive {
    // main is a method that contains all of the code to be executed when a program
    // runs

    // This is a class variable that is available to every method
    // If you declare a variable in a method it is only accessible in that method
    // (local variable)

    static double myPI = 3.14159265;

    // Any changes made to randomNumber in any functions will effect its global
    // value
    ...
    public static void main(String[] args) {
        ...
        while (guessResult != -1) {
            ...
            // You can't declare this variable inside the while loop if you want to access
    ...
    // Java Methods can return any primitive data type, or reference to an object
    // (More on that later)

    public static int addThem(int a, int b) {
        double smallPI = 3.140; // This variable is local to the addThem function

        // compare returns 0 if equal | -1 if smallPI is less than myPI | 1 if smallPI
        // is greater than myPI
    ...
    public static int getRandomNum() {
        ...
        // Since randomNumber is a class variable you don't have to declare, or define
        // its type
        // If int randomNumber was declared in this method it wouldn't effect the global
        // variable named randomNumber
