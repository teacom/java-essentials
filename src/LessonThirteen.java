...
public class LessonThirteen {
    ...
    public static void main(String[] args) {
        ...
        int numTwo = 2;
        System.out.println(numTwo + " " + randomString);
        ...
        String letters = "abcdexy";
        String moreLetters = "hghijklll";
        ...
        System.out.println(letters.indexOf("de"));

        // // You can also specify the index to start searching from
        System.out.println(letters.lastIndexOf("xy"));
