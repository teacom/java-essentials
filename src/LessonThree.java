public class LessonThree {
    ...
    public static void main(String[] args) {
        ...
        // If randomNumber is less than 25, execute the code between {} and then stop
        // checking
        if (randomNumber < 25) {
            System.out.println("The random number is less than 25");
        }

        // If randomNumber wasn't less than 25, then check if it's greater than it. If
        // so, execute the code between {} and then stop checking
         ...
         * ! : Converts the boolean value to its right to its opposite form ie. true to
         * false
         ...
         * ^ : Returns true if there is 1 true and 1 false boolean value on the right or
         * left
         */
        ...
        // The Conditional or Ternary Operator assigns one or another value based on a
        // condition
        ...
        /*
         * When you have a limited number of possible values a switch statement makes
         * sense
         * The switch statement checks the value of theGrade to the values that follow
         * case
         * If it matches it executes the code between {} and then break ends the switch
         * statement
