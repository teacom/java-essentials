...
public class HelloWorld {
    ...
    public static void main(String[] args) {
        ...
        // println is a function that prints to the screen what ever you provide between
        // braces
        // "Hello World" is a string of characters. Strings must be surrounded with
        // quotes
        ...
        // integerOne is a local variable to the main function. It can only be accessed
        // in main
        int integerOne = 22;
